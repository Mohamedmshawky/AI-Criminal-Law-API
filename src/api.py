...
MODEL_PATH = r"D:\Users\moels\PycharmProjects\chat_1\backend\src\audio_rf_model.pkl"
SCALER_PATH = r"D:\Users\moels\PycharmProjects\chat_1\backend\src\audio_scaler.pkl"

# تحميل الموديلات بـ joblib مباشرة (مش محتاج open f)
...
def extract_features(audio_file):
    ...
    # 1. توحيد الطول لـ 3 ثواني (48000 عينة) كما في التدريب
    ...
    # 2. استخراج 40 MFCC + Deltas = 120 ميزة
    mfcc = librosa.feature.mfcc(y=y, sr=16000, n_mfcc=40)
    delta_mfcc = librosa.feature.delta(mfcc)
    delta2_mfcc = librosa.feature.delta(mfcc, order=2)

    # 3. دمج الميزات (التأكد من أن المجموع 120)
    combined = np.hstack([
        np.mean(mfcc, axis=1),
...
async def detect_audio(file: UploadFile = File(...)):
    # استخدام ملف مؤقت أو BytesIO هو الأضمن
...
IMAGE_MODEL_PATH = r"D:\Users\moels\PycharmProjects\chat_1\backend\Data\Face_Models\best_pretrained_model2.h5"
